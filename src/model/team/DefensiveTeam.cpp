...
DefensiveTeam::DefensiveTeam(TeamType type,
...
DefensiveTeam::DefensiveTeam(const std::string &name, const std::string &stadiumName,
    double budget) : Team(TeamType::DEFENSIVE, name, stadiumName, budget) {
}
